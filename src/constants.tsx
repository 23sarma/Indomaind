...
export const ALL_TOOLS: Tool[] = [
  ...
  // FIX: Assigned incorrect component. Changed StartupIdeaGenerator to StudentTutor for better placeholder functionality, which likely resolves the cryptic build error.
